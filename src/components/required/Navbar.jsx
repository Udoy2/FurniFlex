      ...
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div className="flex items-center space-x-4 mr-5">
          ...
          <div className="relative">
            {!isAuthenticated ?
              <Link to="/login">
                <FontAwesomeIcon icon={faSignInAlt} className="text-gray-700 text-2xl cursor-pointer" />
              </Link>
              :
              <div className="relative">
                <FontAwesomeIcon icon={faUserCircle} onClick={toggleDropdown} className="text-gray-700 text-2xl cursor-pointer" />
                {dropdownOpen && (
